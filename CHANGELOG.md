...
- **Additional Iranian Identifier Research & Decision Gate (Phase 27):**
  ...
  - Standard-library-only research reference implementations (`research/legal_entity_id_reference.py`) resolving checksum algorithm disagreements across community implementations and confirming consensus prime-weight formula with 10th-digit offset against empirical public records.
